...
kmeans = KMeans(n_clusters=centers,n_init=10)
kmeans.fit(X)
...
Running this code gives us a visual representation of the clustered data points, showing how K-Means algorithm groups the data into distinct clusters. This is a simple yet effective way to understand the concept of clustering in machine learning.
